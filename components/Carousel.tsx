                    ...
                    <div className="slide aspect-square h-full flex-shrink-0 snap-center  overflow-hidden p-8 w-[25.125em]       border   border-[#E7E7E7]   rounded-md ">
                        <div className="">
                            ...
                            <svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g clip-path="url(#clip0_927_15484)">
                        ...
                        <p className='font-normal text-[17px] mt-1'>
                            We develop the land into profitable properties, such as residential or commercial buildings, to increase the land's value and generate income for investors. Monitor market trends: We constantly monitor market trends and adapt to changes in order to maximize our returns and provide valuable investments for our clients.  </p>
                    </div>
