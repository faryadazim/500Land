...
export default function Home() {
  ...
  const fetchCityRecord = async () => {
    let data = await supabase.from("country").select("country_name");
  };
  ...
  return (
    <>
      ...
      <section className={`hero-section relative min-h-screen`}>
        ...
        <div
          className={`flex min-h-screen flex-col sticky top-0 z-50 container`}
        >
              ...
              <nav className="flex">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    " text-white w-100 px-10 rounded-full font-normal"
                  )}
                  style={{ fontFamily: "Basier Square Regular" }}
                  onClick={() => {
          ...
          <div
            className=" pb-5 relative md:absolute bottom-0  w-full mt-28 md:m-auto mv-12 md:mb-auto md:w-3/5  left-auto     top-1/3"
            style={{ minHeight: "auto" }}
          >
            <div className=" ">
              <h1
                className={`font-bold text-white text-7xl leading-tight     ${inter.className} `}
                style={{ textShadow: "0px 1px 1px rgba(0, 0, 0, 0.15)" }}
              >
                Invest in land.
              </h1>
              <p
                className=" font-normal text-white text-xl leading-8   mb-6 "
                style={{ fontFamily: "Basier Square Regular" }}
              >
                Invest in your future, starting at $100. We specialize in land
                investments that offer stability, returns, and diversification
                for your portfolio.
              </p>
              <div className="flex  ">
                <Link
                  ...
                  className={cn(
                    ...
                    " text-center mr-2   w-100 px-4 md:px-6 rounded-full md:font-bold font-normal  py-6 "
                  )}
      ...
      <section className="my-14 container" id="info-section">
        <div className="flex flex-wrap ">
          <div className="w-full  ">
            ...
            {/* md:w-3/5 */}
            <h3
              className={` ${inter400.className}  font-normal  leading-tight text-lg md:text-[34px]  text-black flex-none order-none self-stretch flex-grow-0  text-center   `}
            >
              We select land based on its investment potential by evaluating
              factors such as location, potential for development, and market
              conditions.
            </h3>
          </div>
        </div>
        ...
        <div className="container py-14">
          ...
          <div className="flex flex-wrap   md:flex-nowrap ">
            ...
            <div className="w-100 md:w-1/2  md:ml-3 h-auto    bg-white flex flex-col justify-start mb-5 rounded-2xl p-5">
              ...
              <p className="mt-4  text-left   text-xl font-normal ">
                As land values increase over time, investors can potentially see
          ...
          <div className="flex flex-wrap   md:flex-nowrap ">
            <div className="w-100 md:w-1/2  md:mr-3 h-auto    bg-white flex flex-col justify-start mb-5 rounded-2xl  p-5">
              ...
              <p className="mt-4  text-left  text-xl font-normal">
                The value of land generally increases with inflation, providing
                a hedge against the declining purchasing power of cash and other
            ...
            <div className="w-100 md:w-1/2  md:ml-3 h-auto    bg-white flex flex-col justify-start mb-5 rounded-2xl p-5">
              ...
              <p className="mt-4  text-left  text-xl font-normal    ">
                Land investments can provide diversification in an investment
                portfolio, since they are not directly linked to the performance
                of the stock market or other financial markets.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container my-14">
        ...
        <h1 className="  pb-6  text-left font-bold leading-tight tracking-normal text-lg md:text-[34px] text-[#101010]">
          Our team of experts at 500Land follows a process to carefully select
          land based on its investment potential, including:
        </h1>
        <div
      ...
      <section className="container my-14">
        ...
        <h1 className="  pb-6  text-left font-bold leading-tight tracking-normal text-lg md:text-[34px] text-[#101010]">
          Our platform allows you to purchase a fractional of a land without the
          need for extensive knowledge or high cost of entry.{" "}
        </h1>
        ...
        <div className=" flex flex-wrap justify-between items-stretch gap-y-3 md:gap-0">
          <div className="md:w-[49%]  bg-customDarkGreen rounded-2xl  flex flex-col  overflow-hidden">
            <div className="lg:p-[52px]  md:p-12 p-5b  p-5 flex-grow   ">
              <div
                id="step1 "
                className="w-10 h-10 rounded-full flex justify-center items-center bg-[#ECFDF3] text-[#039855] "
              >
                1
              </div>
              ...
              <p className="text-[17px]  font-normal text-white">
                Visit our website and create an account by providing your
                personal information, payment information, email address, and
                set a password.{" "}
              </p>
            </div>
            {/* //process image  */}
          ...
          <div className="md:w-[49%]  bg-customDarkGreen rounded-2xl  flex flex-col  overflow-hidden">
            <div className="lg:p-[52px]  md:p-12 p-5   p-5 flex-grow   ">
              ...
              <p className="text-[17px]  font-normal text-white">
                Once you’re logged in, choose our current hedge offerings for a
                land investment, checking the location and investment potential.{" "}
              </p>
            </div>
            {/* //process image  */}
            <div className="flex justify-center">
        ...
        <div className=" flex flex-wrap justify-between items-stretch gap-y-3 md:gap-0 mt-5">
          <div className="md:w-[49%]  bg-customDarkGreen rounded-2xl  flex flex-col  overflow-hidden">
            <div className="lg:p-[52px]  md:p-12 p-5b  p-5 flex-grow   ">
              ...
              <p className="text-[17px]  font-normal text-white">
                Select the land fund that best fits your investment goals and
                needs.{" "}
              </p>
            </div>
            {/* //process image  */}
          ...
          <div className="md:w-[49%]  bg-customDarkGreen rounded-2xl  flex flex-col overflow-hidden">
            <div className="lg:p-[52px]  md:p-12   p-5 flex-grow   ">
              ...
              <p className="text-[17px]  font-normal text-white">
                Once you’ve selected the land you want to invest in, complete
                the purchase through our secure online payment.{" "}
              </p>
            </div>
            {/* //process image  */}
            <div className="flex justify-center">
      ...
      <section className="container my-6">
        <div className="header flex justify-between mt-20 items-center">
          ...
          <Button
            variant="secondary"
            className="bg-white text-customDarkGreen  text-base font-normal  "
          >
      ...
      <section className="container my-6 ">
        ...
        <div id="marketplace-para " className="text-base font-normal">
          Our user-friendly platform simplifies the process of creating and
          managing your land listings. Just provide the essential details,
          upload high-quality images, and set the price. Whether you have a
          vacant lot, or commercial land for sale, the 500Land Marketplace
          connects you with interested buyers.
        </div>
              ...
              <div className="md:w-[32%] w-full  my-2 md:my-1" key={x}>
                <div className="bg-white  shadow-md  rounded-2xl  h-100    ">
                  ...
                  <div className="lg:p-6 p-4">
                    ...
                    <h2 className="text-xl font-bold mb-3 ">
                      <Link href="/marketplace/marketplace-single">
                        Contact Seller Lynch Canyon Road
                      </Link>
                    </h2>
                    <div className="flex justify-between">
                      <span className="price  md:mb-0 mb-1  font-bold text-base leading-5 text-black">
                        $ 1,023,550
                      </span>
                    </div>
                    ...
                    <div className="flex justify-center">
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button
                            variant="primaryDark"
                            className="w-full text-center lg:w-[90%]  px-6 rounded-full font-bold lg:font-semibold md:font-normal    py-6  md:my-1 lg:my-2  "
                            style={{ fontFamily: "sans-serif" }}
                          >
                            Contact Seller
                          </Button>
        ...
        <div className="container  ">
          ...
          <Accordion type="single" collapsible className="w-full py-5">
            {[
              {
                index: 1,
                question: "What is 500Land?",
                answer:
                  "500Lands mission is to make land investment accessible and easy for everyone by providing exceptional investment opportunities in the land market. We identify and acquire undervalued land with the goal of maximizing returns for our clients.",
              },
              {
                index: 2,
              ...
              {
                index: 3,
                question: "What are the benefits of investing in land?",
                answer:
                  "500Lands mission is to make land investment accessible and easy for everyone by providing exceptional investment opportunities in the land market. We identify and acquire undervalued land with the goal of maximizing returns for our clients.",
              },
              {
                index: 4,
                question: "How does 500Land select land for investment?",
                answer:
                  "500Lands mission is to make land investment accessible and easy for everyone by providing exceptional investment opportunities in the land market. We identify and acquire undervalued land with the goal of maximizing returns for our clients.",
              },
              {
                index: 5,
                question: "What services does 500Land offer?",
                answer:
                  "500Lands mission is to make land investment accessible and easy for everyone by providing exceptional investment opportunities in the land market. We identify and acquire undervalued land with the goal of maximizing returns for our clients.",
              },
              {
                index: 6,
                question:
                  "Does 500Land provide ongoing management and monitoring of investments?",
                answer:
                  "500Lands mission is to make land investment accessible and easy for everyone by providing exceptional investment opportunities in the land market. We identify and acquire undervalued land with the goal of maximizing returns for our clients.",
              },
              ...
              return (
                <AccordionItem
                  value={`item-${x.index}`}
                  className="bg-customLightDark rounded-3xl my-3 px-5"
                  key={x.index}
                >
                  <AccordionTrigger className="text-white text-left font-medium text-[17px]">
                    {x.question}
                  </AccordionTrigger>
