        ...
        <div className={`flex min-h-screen flex-col sticky top-0 z-50 container`}>
          ...
          <header className="container   top-0 z-48">
            <div className="flex h-16 items-center justify-between pt-7" >
              ...
              <nav className="flex">
                <Link href="/blogs" className={cn("flex items-center text-lg  text-slate-600 sm:text-sm text-white tracking-widest mx-3 hidden md:flex text-[15px]  font-normal  ")} style={{ fontFamily: "Basier Square Regular" }}>Blogs</Link>
                <Link href="/contact-us" className={cn("flex items-center text-lg   text-slate-600 sm:text-sm text-white tracking-widest mx-3 hidden  md:flex text-[15px]  font-normal  ")} style={{ fontFamily: "Basier Square Regular" }}>Contact Us</Link>
          ...
          <div className=" pb-5 relative md:absolute bottom-0 left-0  w-full mt-28 md:m-auto mv-12 md:mb-auto md:w-3/5  left-auto     top-1/3" style={{ minHeight: "auto" }}>
            <div className=" ">
              ...
              <div className="flex container">
                <Link href="/login" className={cn(buttonVariants({ variant: "primary" }), " text-center mr-2   w-100 px-6 rounded-full font-bold  py-6 ")} style={{ fontFamily: "sans-serif" }}>Check Available Opportunity</Link>
      ...
      <section className="my-14 container" id="info-section">
        <div className="flex flex-wrap ">
          <div className="w-full  ">   {/* md:w-3/5 */}
            <h3 className={` ${inter400.className}  font-normal text-[34px]  text-black flex-none order-none self-stretch flex-grow-0  text-center   `} >
      ...
      <section className="container my-6">
        ...
        <div className="flex flex-wrap  mt-6 justify-between">
          {[1, 2, 3].map((x: any, index: number): any => {
            return (
              <div className="md:w-[32%]   my-2 md:my-0" key={x}>
                <div className="bg-white  shadow-md  rounded-2xl  h-100    ">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-center">
                      <Link href="/opportunities" className={cn(buttonVariants({ variant: "primaryDark" }), "  mr-2   w-[90%] px-6 rounded-full font-bold  py-6 my-2")} style={{ fontFamily: "sans-serif" }}>Funds start from $100 / Share</Link>
                    </div>
                    <div className="flex justify-center">
                      <p className="h-5 font-normal text-[15px] leading-5 flex items-center text-center text-green-900">
