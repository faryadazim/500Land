        ...
        <div className="relative md:pt-20 lg:pt-16 pb-32 pt-12">
          <div className="px-4 md:px-8 lg:px-30 xl:px-36  mx-auto w-full">
              ...
              {CARD_DATA.map((items, index) => (
                <>
                  <div
                    ...
                    key={index}
                    style={{
                      borderRight: index === 3 ? "" : "1px solid #E7E7E7",
                    }}
                  >
                    <h3 className="font-medium text-lg">{items?.heading}</h3>
                    <div className="flex justify-center">
                      <h1 className="font-bold text-2xl">{items?.price}</h1>
                      {items.heading === "Total Profit" ||
                      items.heading === "Investment" ? (
                        <>
                          <div
                            className="flex"
              ...
              >
                <div className="flex items-center justify-center px-4">
                  <CollapsibleTrigger asChild>
                    <Button
                      className="p-0 text-lg font-medium bg-transparent text-customDarkGreen hover:bg-transparent hover:text-customDarkGreen"
                      onClick={() => setIsOpen(!isOpen)}
                    >
                      <p className="text-customDarkGreen font-bold text-[15px]">
                      ...
                      <div
                        className={`${index == 0 && `rounded-t-md`} ${
                          index == 1
                            ? `rounded-b-md border`
                            : `border border-b-0 `
                        } flex flex-wrap    p-6 font-mono text-sm bg-white w-full`}
                        key={index}
                      >
                        <div className="w-1/5">
            ...
            <div className="lg:flex justify-between mt-4">
              <h1 className="font-bold text-[28px] mb-3">
                Other Opportunities
              </h1>
            </div>
            {[1, 2, 3].map((x: any): any => {
