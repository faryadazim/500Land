          ...
          <div className="px-4 md:px-36 mx-auto w-full">
            <div className='lg:flex justify-between my-6'  >
              ...
              <div className="">
                ...
                >
                  Withdraw
                </Button>                <Button className='text-[15px]  text-white font-bold rounded-full px-6 text-md md:ml-3 ml-2   bg-customDarkGreen '
