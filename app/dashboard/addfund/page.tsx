          ...
          <div className="container">
            ...
            <div className="grid gap-14 lg:grid-cols-2 w-full sm:w-4/5 xl:w-full ">
              ...
              <div className="">
                ...
                <div className="font-normal text-[13px] mt-4">
                  <Button variant="primaryDark" className="w-44 p-5  mr-2    text-center     rounded-full font-bold lg:font-semibold md:font-normal  md:my-1   " style={{ fontFamily: "Basier Square Regular" }}>Confirm and Pay</Button>
                </div>
              </div>
