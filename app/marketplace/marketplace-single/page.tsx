        ...
        <div className={`flex   flex-col sticky top-0 z-50`}>
          ...
          <div className="container flex justify-between mt-10 ">
            ...
            <div className="shareButton w-3/12 text-right">
              <p
                className={`text-[34px] font-bold text-white ${inter.className}`}
              >
                $2,000,000
              </p>
          ...
          <div className="w-full md:w-8/12 mr-2">
            ...
            <div className="rounded-[14px] p-5  bg-white border  ">
              <div className="  font-normal text-xl leading-6 text-black">
                Amazing apartment with stunning skyline views to Manhattan and
                the Empire State. dont look further if you need a quick access
                to to Hudson Yards, Time Square, Hells Kitchen, Javits Center,
                the Summit Vanderbilt , Bryant Park, The Vessel and many more
              </div>
            </div>
              ...
              <div className=" w-full  my-2 mb-3">
                <div className="bg-white  shadow  p-6  rounded-2xl  h-100    ">
                  ...
                  <div>
                    <div
                      id="locationHeading"
                      className={`${inter.className} font-medium text-sm text-[#475467] `}
                    >
                      {" "}
                      Location
                    </div>
                    <div id="locationValue" className="flex mt-1">
                      {" "}
                      <span className="mr-2">
                        <svg
                          width={20}
                        ...
                        >
                          <g clipPath="url(#clip0_534_35685)">
                            ...
                            />
                            <path
                              d="M10.0011 -0.000244141C5.70141 -0.000244141 2.03598 2.71351 0.623047 6.52151H19.3791C17.9661 2.71351 14.3007 -0.000244141 10.0011 -0.000244141Z"
                              fill="#D80027"
                            />
                            <path
                              d="M10.0011 20.0003C14.3007 20.0003 17.9661 17.2865 19.3791 13.4785H0.623047C2.03598 17.2865 5.70141 20.0003 10.0011 20.0003Z"
                              fill="black"
                            />
                            <path
                              d="M13.478 8.91303H10.8693C10.8693 8.43279 10.48 8.04346 9.99976 8.04346C9.51953 8.04346 9.13019 8.43279 9.13019 8.91303H6.52148C6.52148 9.3933 6.9398 9.7826 7.42004 9.7826H7.39105C7.39105 10.2629 7.78035 10.6522 8.26062 10.6522C8.26062 11.1324 8.64992 11.5217 9.13019 11.5217H10.8693C11.3496 11.5217 11.7389 11.1324 11.7389 10.6522C12.2192 10.6522 12.6085 10.2629 12.6085 9.7826H12.5795C13.0598 9.7826 13.478 9.3933 13.478 8.91303Z"
                              fill="#FF9811"
                            />
                          </g>
                          <defs>
                      ...
                      <span
                        className={`${inter.className} font-medium text-base text-[#475467] `}
                      >
                        {" "}
                        Cairo, Egypt
                      </span>
